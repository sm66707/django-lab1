...
from .views import todo_details, todo_home, todo_json_home,todo_list,todo_done,todo_delete,todo_edit,todo_update
...
urlpatterns=[
    ...
    path('detail/<str:todo_name>',todo_details ,name= 'detail'),
